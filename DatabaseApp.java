...
public class DatabaseApp {
  ...
  private static void printHelp() {
    ...
    System.out.printf("%-3s %-50s %s%n", "4.", "neighborhoods <numOfNeighborhoods>",
        "Get <numberOfNeighborhoods> neighborhoods in the neighborhoods table.");
    System.out.printf("%-3s %-50s %s%n", "5.", "species <parkID>", "Get all unique species in the given <parkID>.");
    System.out.printf("%-3s %-50s %s%n", "6.", "popParkAssets <-most/-least> <numberOfAssets>",
        "Get parks with <-most/-least> assets. <numberOfAssets> is the length of the list.");
    System.out.printf("%-3s %-50s %s%n", "7.", "popParkTrees <-most/-least> <numberOfTrees>",
        "Get parks with <-most/-least> trees. <numberOfTrees> is the length of the list.");
    System.out.printf("%-3s %-50s %s%n", "8.", "popNTrees <-most/-least> <numberOfTrees>",
        "Get neighborhoods <-most/-least> trees. <numberOfTrees> is the length of the list.");
    System.out.printf("%-3s %-50s %s%n", "9.", "denseN <-most/-least> <numberOfNeighborhoods>",
        "Get <-most/-least> dense neighborhoods (Neighborhoods with the <-most/-least> number of houses.)");
    System.out.printf("%-3s %-50s %s%n", "10.", "houses <streetName>", "Get houses on the given street.");
    System.out.printf("%-3s %-50s %s%n", "11.", "parkTrees <-fewer/-greater> <numberOfTrees>",
        "Get parks with <-fewer/-greater> trees than <numberOfTrees>.");
    System.out.printf("%-3s %-50s %s%n", "12.", "nTrees <-fewer/-greater> <numberOfTrees>",
        "Get neighborhoods with <-fewer/-greater> trees than <numberOfTrees>.");
    System.out.printf("%-3s %-50s %s%n", "13.", "nullAssets", "Get assets that are not in any park");
    System.out.printf("%-3s %-50s %s%n", "14.", "parkAssets <-fewer/-greater> <numberOfAssets>",
        "Get parks with <-fewer/-greater> assets than <numberOfAssets>.");
    System.out.printf("%-3s %-50s %s%n", "15.", "name <botanicalName>", "Get the common name of <botanicalName>.");
    System.out.printf("%-3s %-50s %s%n", "16.", "average <parkName>",
        "Get the average diameter of trees in the given park.");
    System.out.printf("%-3s %-50s %s%n", "17.", "treeCount <botanicalName>",
        "Get the tree count for the given species botanical name.");
    System.out.printf("%-3s %-50s %s%n", "18.", "popSpecies <-most/-least> <numberOfSpecies>",
        "Get <-most/-least> popular species. <numberOfSpecies> is the length of the list.");
    System.out.printf("%-3s %-50s %s%n", "19.", "popNSpecies <neighborhoodName, x>",
        "Get x msot popular tree species in the <neighborhoodname>. x is the length of the list.");
    System.out.printf("%-3s %-50s %s%n", "20.", "diameter <-range/-greater/-fewer> <diameter>",
        "Get trees which have diameter <-greater/-fewer> than the specified <diameter>,");
    System.out.printf("%-3s %-50s %s%n", "", "",
        "or which have diamter in <-range> of the given <diameter>, if range the format of <diameter> has to be minRange-maxRange (eg. 5-10)");
    System.out.printf("%-3s %-50s %s%n", "21.", "delete", "Delete all the tables and the records in the database.");
    System.out.printf("%-3s %-50s %s%n", "22.", "init",
        "Initialize the database by creating tables and adding all the records");
...
class MyDatabase {
  ...
  public void delete() {
    try {
      String[] tableNames = { "neighborhoods", "addresses", "trees", "assetPark", "parks", "species", "bioname",
          "assets" };
  ...
  public void insertItems() {
    try {
      // Read the SQL queries from the initialData.sql file
      String sqlFilePath = "data/initialData.sql";
